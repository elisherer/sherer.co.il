...
import PapayaGlobal from "./papayaglobal.svg";
...
import { Resume } from "../providers/ResumeProvider";
...
const resume: Resume = {
  ...
  avatar: "https://www.gravatar.com/avatar/8e308e281247157b097e1578a48755e9?s=160&d=mp",
  aboutMe:
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        {
          href: "https://play.google.com/store/apps/details?id=co.essh.gamecast",
          label: "Play Store",
        },
      ],
    },
    {
      ...
      links: [
        {
          href: "https://play.google.com/store/apps/details?id=co.essh.tinytalk",
          label: "Play Store",
        },
      ],
    },
  ...
  education: [
    ...
    },
    {
      ...
      logo: IgalAlon,
      diploma: "Technological diploma in Software Design and programming course of study",
      institute: "Igal Alon High School, Rishon Lezion",
      honors: "Magna cum laude",
      projects: ["Outlook-like app in C. Calendar, Tasks, Contacts, Notes, Calculator, Alarm and World clock (DOS)"],
    },
  ],
  languages: ["en-US", "he-IL"],
  more: ["Highly motivated", "Team player", "Autodidact (fast)", "Crowd tutoring experience"],
  links: [
    {
      href: "https://wiibrew.org/wiki/Balance_Board_Tools",
      label: "Wii - Balance board tools",
      summary: "The first homebrew to use the Wii Balance Board",
    },
    {
      href: "https://wiibrew.org/wiki/GRRLIB",
      label: "Wii - GRRLIB",
      summary: "Helped with adding more graphics algorithms for the graphics library",
    },
    {
      href: "https://www.3dbrew.org/wiki/3DSExplorer",
      label: "3DSExplorer",
      summary:
        "Aims to be a file explorer for Nintendo’s 3ds associated files (.cci/cia/cxi/sav(save flash)/etc.. ) info from 3dbrew.org",
    },
    {
      href: "https://github.com/elisherer/intelligent-level-editor",
      label: "Intelligent Level Editor",
      summary:
    ...
    {
      href: "https://www.rockbox.org",
      label: "ROCKbox",
      summary: "ROCKbox is a free replacement firmware for digital music players. It runs on a wide range of players",
    },
    {
      href: "https://www.rockbox.org/wiki/PluginRockblox",
      label: "ROCKbox - Rockblox",
      summary: "Tetris Clone (source: https://git.rockbox.org/cgit/rockbox.git/tree/apps/plugins/rockblox.c)",
    },
    {
      href: "https://www.rockbox.org/wiki/PluginXobox",
      label: "ROCKbox - Xobox",
      summary: "Qix Clone (source: https://git.rockbox.org/cgit/rockbox.git/tree/apps/plugins/xobox.c)",
    },
    {
      href: "https://www.rockbox.org/wiki/PluginRockpaint",
      label: "ROCKbox - RockPaint",
      summary:
